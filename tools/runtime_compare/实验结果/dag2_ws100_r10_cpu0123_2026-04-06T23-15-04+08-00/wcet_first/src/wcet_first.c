...
static pthread_t thread_stage0;
static pthread_t thread_stage1;
static pthread_t thread_stage2;
static pthread_t thread_stage3;
...
static sem_t sem_stage01;
static sem_t sem_stage12;
static sem_t sem_stage23;
...
int main(void)
{
    ...
    init_matrices();
    if (sem_init(&sem_stage01, 0, 0) != 0)
        return 1;
    if (sem_init(&sem_stage12, 0, 0) != 0)
        return 1;
    if (sem_init(&sem_stage23, 0, 0) != 0)
        return 1;
    ...
    pthread_create(&thread_stage3, NULL, d_stage3, NULL);
    pthread_create(&thread_stage2, NULL, c_stage2, NULL);
    pthread_create(&thread_stage1, NULL, b_stage1, NULL);
    pthread_create(&thread_stage0, NULL, a_stage0, NULL);
    ...
    pthread_join(thread_stage3, NULL);
    pthread_join(thread_stage2, NULL);
    pthread_join(thread_stage1, NULL);
    pthread_join(thread_stage0, NULL);
