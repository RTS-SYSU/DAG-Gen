 ...
 *
 * Total: main x3 MU + 21 worker MU = 24 mutexes, 5 semaphores.
 */

#define C1    0.1    /* main#001 init */
#define C2    0.1    /* main#002 final */
#define C24   0.0    /* main#003 bridge: absorbs create/join boundary */

/* Critical-chain nodes (heavy): longest path + diagonal pivots / elim on front */
#define C3    8.5    /* P(0,0) — head pivot, much heavier than off-path */
#define C4    6.2    /* E(0,1) */
#define C5    6.2    /* P(1,1) */
#define C7    6.2    /* E(1,2) */
#define C8    6.2    /* P(2,2) */
#define C11   6.8    /* E(2,3) */
#define C12   7.2    /* P(3,3) */
#define C16   8.0    /* E(3,4) */
#define C17   8.8    /* P(4,4) */
#define C22   9.5    /* E(4,5) */
#define C23   10.0   /* P(5,5) */

/* Off-path elimination: keep low so DAG ranks and wcet_first favor the front */
#define C6    0.15   /* E(0,2) */
#define C9    0.20   /* E(0,3) */
#define C10   0.40   /* E(1,3) */
#define C13   0.25   /* E(0,4) */
#define C14   0.60   /* E(1,4) */
#define C15   1.50   /* E(2,4) */
#define C18   0.40   /* E(0,5) */
#define C19   1.00   /* E(1,5) */
#define C20   2.20   /* E(2,5) */
#define C21   3.00   /* E(3,5) */
...
/* mutex_01..02,24: main ; mutex_03..23: GE tasks (21 blocks) */
