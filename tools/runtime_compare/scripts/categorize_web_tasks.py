...
def main() -> int:
    ...
    parser.add_argument(
        "--src",
        default="tools/runtime_compare/实验结果/web_tasks",
        help="Source web_tasks directory (default: tools/runtime_compare/实验结果/web_tasks)",
    )
    parser.add_argument(
        "--dest",
        default="experiment/zhang1实验结果汇总",
        help="Destination root directory (default: experiment/zhang1实验结果汇总)",
    )
