...
SEG_BEGIN("MU:worker_main#001@57-60");
    busy_wait_seconds(C3);
SEG_END("MU:worker_main#001@57-60");
    pthread_mutex_unlock(&mutex_03);

    pthread_mutex_lock(&mutex_04);
SEG_BEGIN("MU:worker_main#002@61-64");
    busy_wait_seconds(C4);
SEG_END("MU:worker_main#002@61-64");
