...
SEG_BEGIN("SEG:main#007@143-148");
...
SEG_END("SEG:main#007@143-148");
  pthread_mutex_lock(&mu_tail);
SEG_BEGIN("MU:main#008@149-151");
  busy_wait_seconds(TAIL);
SEG_END("MU:main#008@149-151");
  pthread_mutex_unlock(&mu_tail);
SEG_BEGIN("SEG:main#009@152-154");

  sem_destroy(&sem_c12);
  sem_destroy(&sem_c23);
SEG_END("SEG:main#009@152-154");
  return 0;
}
