...
SEG_BEGIN("MU:critical_fn#001@123-125");
  busy_wait_seconds(C2);
SEG_END("MU:critical_fn#001@123-125");
...
SEG_BEGIN("MU:filler_a#001@132-134");
  busy_wait_seconds(C3);
SEG_END("MU:filler_a#001@132-134");
...
SEG_BEGIN("MU:filler_b#001@141-143");
  busy_wait_seconds(C4);
SEG_END("MU:filler_b#001@141-143");
...
SEG_BEGIN("MU:filler_c#001@150-152");
  busy_wait_seconds(C5);
SEG_END("MU:filler_c#001@150-152");
...
SEG_BEGIN("MU:filler_d#001@159-161");
  busy_wait_seconds(C6);
SEG_END("MU:filler_d#001@159-161");
...
SEG_BEGIN("MU:main#001@168-176");
  init_matrices();
  busy_wait_seconds(C1);
SEG_END("MU:main#001@168-176");
...
SEG_BEGIN("MU:main#002@177-184");
  busy_wait_seconds(C7);
SEG_END("MU:main#002@177-184");
