...
SEG_BEGIN("MU:worker_key_c#001@102-105");
    busy_wait_seconds(C9);
SEG_END("MU:worker_key_c#001@102-105");
...
SEG_BEGIN("MU:worker_fill_x#001@137-139");
    busy_wait_seconds(C10);
SEG_END("MU:worker_fill_x#001@137-139");
    pthread_mutex_unlock(&mutex_09);
    pthread_mutex_lock(&mutex_10);
SEG_BEGIN("MU:worker_fill_x#002@140-143");
    busy_wait_seconds(C11);
SEG_END("MU:worker_fill_x#002@140-143");
...
SEG_BEGIN("MU:worker_fill_y#001@149-151");
    busy_wait_seconds(C12);
SEG_END("MU:worker_fill_y#001@149-151");
    pthread_mutex_unlock(&mutex_11);
    pthread_mutex_lock(&mutex_12);
SEG_BEGIN("MU:worker_fill_y#002@152-155");
    busy_wait_seconds(C13);
SEG_END("MU:worker_fill_y#002@152-155");
...
SEG_BEGIN("MU:worker_fill_z#001@161-163");
    busy_wait_seconds(C14);
SEG_END("MU:worker_fill_z#001@161-163");
    pthread_mutex_unlock(&mutex_13);
    pthread_mutex_lock(&mutex_14);
SEG_BEGIN("MU:worker_fill_z#002@164-167");
    busy_wait_seconds(C15);
SEG_END("MU:worker_fill_z#002@164-167");
...
SEG_END("MU:main#001@173-183");
    }
    pthread_mutex_unlock(&mutex_16);
    pthread_mutex_lock(&mutex_01);
SEG_BEGIN("MU:main#002@184-189");
    busy_wait_seconds(C1);
SEG_END("MU:main#002@184-189");
...
SEG_BEGIN("MU:main#003@190-193");
    busy_wait_seconds(C2);
SEG_END("MU:main#003@190-193");
...
SEG_BEGIN("MU:main#004@194-199");
    busy_wait_seconds(C3);
SEG_END("MU:main#004@194-199");
...
SEG_BEGIN("MU:main#005@200-205");
    busy_wait_seconds(C4);
SEG_END("MU:main#005@200-205");
