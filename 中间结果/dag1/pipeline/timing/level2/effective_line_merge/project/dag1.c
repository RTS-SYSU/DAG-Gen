...
static sem_t sem_gate2_after_gate1;
static sem_t sem_tail2_after_tail1;
...
SEG_BEGIN("MU:tail_worker_1#001@124-127");
    busy_wait_seconds(C22);
SEG_END("MU:tail_worker_1#001@124-127");
    pthread_mutex_unlock(&mutex_22);
    sem_post(&sem_tail2_after_tail1);
    return NULL;
}

static void *tail_worker_2(void *arg)
{
    sem_wait(&sem_tail2_after_tail1);
    pthread_mutex_lock(&mutex_23);
SEG_BEGIN("MU:tail_worker_2#001@133-136");
    busy_wait_seconds(C23);
SEG_END("MU:tail_worker_2#001@133-136");
...
SEG_BEGIN("MU:noise_worker_a#001@168-170");
    busy_wait_seconds(C6);
SEG_END("MU:noise_worker_a#001@168-170");
    pthread_mutex_unlock(&mutex_06);
    pthread_mutex_lock(&mutex_07);
SEG_BEGIN("MU:noise_worker_a#002@171-173");
    busy_wait_seconds(C7);
SEG_END("MU:noise_worker_a#002@171-173");
...
SEG_BEGIN("MU:noise_worker_b#001@179-181");
    busy_wait_seconds(C8);
SEG_END("MU:noise_worker_b#001@179-181");
    pthread_mutex_unlock(&mutex_08);
    pthread_mutex_lock(&mutex_09);
SEG_BEGIN("MU:noise_worker_b#002@182-184");
    busy_wait_seconds(C9);
SEG_END("MU:noise_worker_b#002@182-184");
...
SEG_BEGIN("MU:noise_worker_c#001@190-192");
    busy_wait_seconds(C10);
SEG_END("MU:noise_worker_c#001@190-192");
    pthread_mutex_unlock(&mutex_10);
    pthread_mutex_lock(&mutex_11);
SEG_BEGIN("MU:noise_worker_c#002@193-195");
    busy_wait_seconds(C11);
SEG_END("MU:noise_worker_c#002@193-195");
...
SEG_BEGIN("MU:noise_worker_d#002@204-206");
    busy_wait_seconds(C13);
SEG_END("MU:noise_worker_d#002@204-206");
...
SEG_BEGIN("MU:noise_worker_e#001@212-214");
    busy_wait_seconds(C14);
SEG_END("MU:noise_worker_e#001@212-214");
    pthread_mutex_unlock(&mutex_14);
    pthread_mutex_lock(&mutex_15);
SEG_BEGIN("MU:noise_worker_e#002@215-217");
    busy_wait_seconds(C15);
SEG_END("MU:noise_worker_e#002@215-217");
...
SEG_BEGIN("MU:noise_worker_f#001@223-225");
    busy_wait_seconds(C16);
SEG_END("MU:noise_worker_f#001@223-225");
    pthread_mutex_unlock(&mutex_16);
    pthread_mutex_lock(&mutex_17);
SEG_BEGIN("MU:noise_worker_f#002@226-228");
    busy_wait_seconds(C17);
SEG_END("MU:noise_worker_f#002@226-228");
...
SEG_BEGIN("MU:main#001@234-257");
    ...
    sem_init(&sem_gate2_after_gate1, 0, 0);
    sem_init(&sem_tail2_after_tail1, 0, 0);
...
SEG_END("MU:main#001@234-257");
    pthread_mutex_unlock(&mutex_01);
    pthread_mutex_lock(&mutex_02);
SEG_BEGIN("MU:main#002@258-264");
...
SEG_END("MU:main#002@258-264");
    pthread_mutex_unlock(&mutex_02);
    pthread_mutex_lock(&mutex_03);
SEG_BEGIN("MU:main#003@265-273");
...
SEG_END("MU:main#003@265-273");
    pthread_mutex_unlock(&mutex_03);
    pthread_mutex_lock(&mutex_04);
SEG_BEGIN("MU:main#004@274-276");
    busy_wait_seconds(C4);
SEG_END("MU:main#004@274-276");
    pthread_mutex_unlock(&mutex_04);
    pthread_mutex_lock(&mutex_05);
SEG_BEGIN("MU:main#005@277-281");
    busy_wait_seconds(C5);
    sem_destroy(&sem_gate2_after_gate1);
    sem_destroy(&sem_tail2_after_tail1);
SEG_END("MU:main#005@277-281");
