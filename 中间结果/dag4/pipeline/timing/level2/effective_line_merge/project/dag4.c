...
#define C3    10.0   /* P(0,0) — head pivot, much heavier than off-path */
#define C4    7.5    /* E(0,1) */
#define C5    7.5    /* P(1,1) */
#define C7    7.5    /* E(1,2) */
#define C8    7.5    /* P(2,2) */
#define C11   7.5    /* E(2,3) */
#define C12   7.5    /* P(3,3) */
#define C16   7.5    /* E(3,4) */
#define C17   7.5    /* P(4,4) */
#define C22   7.5    /* E(4,5) */
#define C23   7.5    /* P(5,5) */

/* Off-path elimination: keep low so DAG ranks and wcet_first favor the front */
#define C6    0.35   /* E(0,2) */
#define C9    0.35   /* E(0,3) */
#define C10   0.35   /* E(1,3) */
#define C13   0.35   /* E(0,4) */
#define C14   0.35   /* E(1,4) */
#define C15   0.35   /* E(2,4) */
#define C18   0.35   /* E(0,5) */
#define C19   0.35   /* E(1,5) */
#define C20   0.35   /* E(2,5) */
#define C21   0.35   /* E(3,5) */
...
SEG_BEGIN("MU:main#002@298-307");
  busy_wait_seconds(C2);
SEG_END("MU:main#002@298-307");
