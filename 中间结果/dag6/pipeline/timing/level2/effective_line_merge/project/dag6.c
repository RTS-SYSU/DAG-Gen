...
SEG_BEGIN("MU:filler_01#001@94-96");
  busy_wait_seconds(C7);
SEG_END("MU:filler_01#001@94-96");
...
SEG_BEGIN("MU:filler_02#001@101-103");
  busy_wait_seconds(C8);
SEG_END("MU:filler_02#001@101-103");
...
SEG_BEGIN("MU:filler_03#001@108-110");
  busy_wait_seconds(C9);
SEG_END("MU:filler_03#001@108-110");
...
SEG_BEGIN("MU:filler_04#001@115-117");
  busy_wait_seconds(C10);
SEG_END("MU:filler_04#001@115-117");
...
SEG_BEGIN("MU:filler_05#001@122-124");
  busy_wait_seconds(C11);
SEG_END("MU:filler_05#001@122-124");
...
SEG_BEGIN("MU:filler_06#001@129-131");
  busy_wait_seconds(C12);
SEG_END("MU:filler_06#001@129-131");
...
SEG_BEGIN("MU:d_stage3#001@136-139");
  busy_wait_seconds(C6);
SEG_END("MU:d_stage3#001@136-139");
...
SEG_BEGIN("MU:c_stage2#001@144-148");
  busy_wait_seconds(C5);
SEG_END("MU:c_stage2#001@144-148");
...
SEG_BEGIN("MU:b_stage1#001@153-157");
  busy_wait_seconds(C4);
SEG_END("MU:b_stage1#001@153-157");
...
SEG_BEGIN("MU:a_stage0#001@162-165");
  busy_wait_seconds(C3);
SEG_END("MU:a_stage0#001@162-165");
...
SEG_BEGIN("MU:main#002@192-205");
  busy_wait_seconds(C2);
SEG_END("MU:main#002@192-205");
