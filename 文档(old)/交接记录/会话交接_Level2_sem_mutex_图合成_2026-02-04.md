...
- 段级测时、LPF、prio 插桩、baseline/prio 对照实验与批量实验归档体系已存在（详见：
	  - `mycallyplus_v1/文档/使用指南/新会话快速上手_段级实验.md`
  - `mycallyplus_v1/文档/代码段切割方法/README_代码段切割与优先级插桩_Level1.md`
	  - `mycallyplus_v1/文档/交接记录/会话交接_自动化工具与测时统一_2026-02-01.md`
	  - `mycallyplus_v1/文档/交接记录/会话交接_多DAG构造与实验流程_2026-02-03.md`
）
...
代码风格约束（必须遵守）：
- `mycallyplus_v1/文档/规范/代码风格_ScratchDAG_线程DAG基准程序.md`
...
- 交接文档（背景）：`mycallyplus_v1/文档/交接记录/会话交接_多DAG构造与实验流程_2026-02-03.md`
- Level‑1 快速上手：`mycallyplus_v1/文档/使用指南/新会话快速上手_段级实验.md`
- Level‑1 规格：`mycallyplus_v1/文档/代码段切割方法/README_代码段切割与优先级插桩_Level1.md`
- ScratchDAG 友好代码风格：`mycallyplus_v1/文档/规范/代码风格_ScratchDAG_线程DAG基准程序.md`
